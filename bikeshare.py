...
def get_filters():
    ...
    # TO DO: get user input for city (chicago, new york city, washington). The input can be starting with capital or small letter. HINT: Use a while loop to handle invalid inputs
